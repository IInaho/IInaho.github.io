...
![](../static/NTwubeiEkoZHzZxf4Utcvi8QnRd.webp)
...
![](../static/VKsIbxW3FoLHxGxkUo9czTqBnkc.webp)
...
![](../static/H8yNbHF0foqThzxY2FRc1rMZnzh.webp)
...
![](../static/IsJzboebDonJD7xEAlbczOxon6b.webp)

## TCP 的端口

![](../static/XNdzbzfmSoM2Ucx4Bbkc5520nlc.webp)
...
![](../static/V0xlbHl8XoJYrYxVI6zc1IVpneg.webp)

### UDP 的首部格式

![](../static/Upq4bawxcoC2TBx5bgCcFgSqnCh.webp)

首部中的长度指的是 UDP 用户数据报的长度(首部 + 数据)，伪首部用于检验和。

### 计算 UDP 检验和的例子

![](../static/LlKwbsTbloYBqNxLrMZc2Ld8nmf.webp)
